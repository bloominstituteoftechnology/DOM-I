...
childNodes[1].innerHTML = siteContent["nav"]["nav-item-1"];
childNodes[3].innerHTML = siteContent["nav"]["nav-item-2"];
childNodes[5].innerHTML = siteContent["nav"]["nav-item-3"];
childNodes[7].innerHTML = siteContent["nav"]["nav-item-4"];
childNodes[9].innerHTML = siteContent["nav"]["nav-item-5"];
childNodes[11].innerHTML = siteContent["nav"]["nav-item-6"];
