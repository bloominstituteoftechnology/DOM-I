...
const mainH41 = document.querySelectorAll('h4')
mainH4[1].textContent = siteContent["main-content"]["about-h4"]

const mainH42 = document.querySelectorAll('h4')
mainH4[2].textContent = siteContent["main-content"]["services-h4"]

const mainH43 = document.querySelectorAll('h4')
mainH4[3].textContent = siteContent["main-content"]["product-h4"]

const mainH44 = document.querySelectorAll('h4')
mainH4[4].textContent = siteContent["main-content"]["vision-h4"]

const mainstuff = document.querySelector('.main-content');
const mainParas = mainstuff.querySelectorAll("p");
