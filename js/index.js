...
const firstArray = Array.from(document.querySelectorAll("a"));
for (i = 0; i < firstArray.length; i++) {
  firstArray[i].innerText = siteContent["nav"]["nav-item-1"];
}
...
const secondTask = document.getElementById("cta-img");
secondTask.setAttribute("src", siteContent["cta"]["img-src"]);
