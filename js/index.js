...
var headerNav = document.body.children[0].children[0].children[0].children;
...
let pic1 = document.getElementById("cta-img");
pic1.setAttribute("src", siteContent["cta"]["img-src"]);

let ctatext = document.querySelector(".cta-text");
ctatext.textContent = "Dom Is Awesome";

// let ctaT2 = document.body.children[0].children[1].children[0].children[0];
// ctaT2.textContent = "asdf";
