...
document.querySelectorAll("h4")[1].textContent =
  siteContent.mainContent["about-h4"];
document.querySelectorAll("h4")[2].textContent =
  siteContent.mainContent["services-h4"];
document.querySelectorAll("h4")[3].textContent =
  siteContent.mainContent["product-h4"];
document.querySelectorAll("h4")[4].textContent =
  siteContent.mainContent["vision-h4"];

//h1 headers End

document.querySelectorAll(".main-content p")[0].textContent =
  siteContent.mainContent["features-content"];
document.querySelectorAll(".main-content p")[1].textContent =
  siteContent.mainContent["about-content"];
document.querySelectorAll(".main-content p")[2].textContent =
  siteContent.mainContent["services-content"];
document.querySelectorAll(".main-content p")[3].textContent =
  siteContent.mainContent["product-content"];
document.querySelectorAll(".main-content p")[4].textContent =
  siteContent.mainContent["vision-content"];
