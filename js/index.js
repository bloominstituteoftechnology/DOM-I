...
let aTags = document.querySelectorAll("a");
 ...
 const newContent = document.createElement("nav-item");
 newContent.textContent = "Sun"
 const parentElement = document.querySelector('nav');
 parentElement.prepend(newContent);

 /*const nextContent = document.createElement("nav-item");
nextContent.textContent = "Moon"
 const parentElement = document.querySelector('nav');
 parentElement.appendChild(nextContent);*/
