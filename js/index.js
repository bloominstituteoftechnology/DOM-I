...
const changeImg = document.querySelector("#cta-img");
changeImg.src = "img/header-img.png";
const middleImg = document.querySelector("#middle-img");
middleImg.src = "img/mid-page-accent.jpg";

const title = document.querySelector("h1");
title.innerHTML = "DOM IS AWESOME".split(' ').join('<br>');


const getStart = document.querySelector('button');
console.log(getStart);
getStart.textContent = "Get Started";

const smallTitle = document.getElementsByTagName('h4');
smallTitle[0].textContent = "FEATURES";
smallTitle[1].textContent = "ABOUT";
smallTitle[2].textContent = "SERVICES";
smallTitle[3].textContent = "PRODUCT";
smallTitle[4].textContent = "VISION";
smallTitle[5].textContent = "CONTACT";
...
pTag[5].innerHTML =  "123 Way 456 Street <br> Somewhere, USA";

pTag[6].textContent = "1 (888) 888-8888";
pTag[7].textContent = "sales@greatidea.io";
pTag[8].textContent = "Copyright Great Idea! 2018";