...
//console.log(contact)
const contactText = contact[0].querySelector('h4')
contactText.textContent = siteContent["contact"]["contact-h4"]
const address = contact[0].querySelector('p')
address.textContent = siteContent["contact"]["address"]
const phone = contact[0].querySelector('p')
phone.textContent = siteContent["contact"]["phone"]
const email = contact[0].querySelector('p')
