...
* [ ] Create a new branch: git checkout -b `<firstName-lastName>`. done
* [ ] Implement the project on your newly created `<firstName-lastName>` branch, committing changes regularly. done
* [ ] Push commits: git push origin `<firstName-lastName>`. done
