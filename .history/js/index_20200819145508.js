...
let topcont = document.querySelectorAll("div.top-content > .text-content")
let toph4 = topcont.querySelectorAll("h4");
toph4[0].textContent = ("src", siteContent["main-content"]["features-h4"]);
