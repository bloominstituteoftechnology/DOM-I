...
// const mainItems = siteContent["main-content"];
// const mainItemsKeys = Object.keys(mainItems);
// console.log(mainItemsKeys);
// const mainItemHeadings = mainItemsKeys.filter(function(currentValue) {
//   return currentValue.includes("h4");
// });
...
newElement.href = "#";
newElement.textContent = "First Link";
...
newElement2.href = "#";
newElement2.textContent = "Last";
newElement2.style.color ="green";
const lastNav = document.querySelector("nav").lastChild.previousSibling
lastNav.append(newElement2);
