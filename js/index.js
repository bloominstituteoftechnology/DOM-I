...
serviceTitle.textContent = siteContent['main-content']['service-h4']
let serviceText = document.querySelector('.text-content p ');
serviceText.textContent = siteContent['main-content']['service-content']
