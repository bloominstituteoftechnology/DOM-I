...
let bottomTitles = document.querySelectorAll(
...
addedP.innerHTML =
  "History content elementum magna eros, ac posuere elvit tempus et. Suspendisse vel tempus odio, in interdutm nisi. Suspendisse eu ornare nisl. Nullam convallis augue justo, at imperdiet metus scelerisque quis.";

//changing the color of the main tital and the text size of the bottom paragraphs
title.style.color = "#0055A8";
bottomContent.forEach((obj, i) => {
  bottomContent[i].style.fontSize = "12px";
});
