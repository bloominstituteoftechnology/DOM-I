...
for (i = 0; i < nav.length - 1; i++) {
  nav[i].innerHTML = siteContent["nav"]["nav-item-1"];
}
...
allH4[i].innerHTML = siteContent["main-content"]["features-h4"];
...
let contPara = document.querySelectorAll(".contact p");
contPara[0].innerHTML = siteContent["contact"]["address"];
contPara[1].innerHTML = siteContent["contact"]["phone"];
contPara[2].innerHTML = siteContent["contact"]["email"];
