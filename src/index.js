...
topContent.children[1].children[1].textContent = siteContent['main-content']['about-cotent']
...
document.querySelector('cta .cta-tect button').textContent = siteContent.cta.button
